...
func TestBuildConfigChangeDetails(t *testing.T) {
	oldCfg := &config.Config{
		...
		RemoteManagement: config.RemoteManagement{
			...
			PanelUpdateIntervalMinutes: 180,
	...
	expectContains(t, details, "remote-management.panel-update-interval-minutes: 180 -> 10")
...
func TestBuildConfigChangeDetails_AllBranches(t *testing.T) {
	...
	expectContains(t, changes, "remote-management.panel-update-interval-minutes: 180 -> 10")
