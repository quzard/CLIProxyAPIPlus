...
func TestBuildKiroPayloadFromOpenAI_UsesConfiguredThinkingDefaults(t *testing.T) {
	input := []byte(`{
	...
	result, thinkingEnabled := BuildKiroPayloadFromOpenAI(input, "kiro-model", "", "CLI", false, false, nil, map[string]any{
		"force_thinking":  "true",
